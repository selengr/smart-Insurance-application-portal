...
export default async function PrivacyPage({
  ...
  const sections = [
    { title: legal.aboutDemo, body: legal.privacyAbout },
    { title: legal.whatWeStore, body: legal.privacyStore },
    { title: legal.whatWeDont, body: legal.privacyDont },
  ]
  ...
  return (
    <main className="relative mx-auto w-full max-w-2xl px-4 py-14 sm:px-6 sm:py-20">
      ...
      <p className="mt-4 text-sm leading-relaxed text-muted-foreground">{legal.privacyBody}</p>
