    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {insuranceTypes.data.map((insurance) => (
        <Link key={insurance.formId} href={`/${lang}/insurance/${insurance.formId}`}>
          <div className="p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer transform hover:-translate-y-1 border border-gray-100">
